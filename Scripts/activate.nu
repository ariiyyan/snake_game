...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\arrar\Desktop\Python practice\snake_game'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\arrar\Desktop\Python practice\snake_game\Scripts\deactivate.nu'
